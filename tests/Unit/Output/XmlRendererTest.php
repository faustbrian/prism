...
describe('XmlRenderer', function (): void {
    describe('render method', function (): void {
        test('renders valid XML output structure', function (): void {
            ...
            expect($dom->getElementsByTagName('compliance_results')->length)->toBe(1)
        ...
        test('returns early when saveXML returns false', function (): void {
            ...
            expect($xml)->toContain('<?xml version="1.0" encoding="UTF-8"?>')
                ->and($xml)->toContain('<compliance_results>');
        });
    });
    ...
    describe('formatFailure method', function (): void {
        ...
        test('formats failure with expectedValid false and actualValid true', function (): void {
            // Arrange
            $output = new BufferedOutput();
            $renderer = new XmlRenderer($output, includeFailures: true);
            $suite = new TestSuite(
