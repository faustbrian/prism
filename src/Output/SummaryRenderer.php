...
final readonly class SummaryRenderer
{
    ...
    private function renderSummary(array $suites): void
    {
        ...
        $dotsNeeded = max(1, $totalWidth - mb_strlen('Passed') - $statsWidth - mb_strlen($passedPercentageStr) - 1);
        $dots = str_repeat('.', $dotsNeeded);
        render(sprintf(
            <<<'HTML'
                <div class="mx-2">
        ...
        $dotsNeeded = max(1, $totalWidth - mb_strlen('Failed') - $statsWidth - mb_strlen($failedPercentageStr) - 1);
        $dots = str_repeat('.', $dotsNeeded);
        render(sprintf(
            <<<'HTML'
                <div class="mx-2">
