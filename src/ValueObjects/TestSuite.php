...
/**
 * Immutable value object representing a complete compliance test suite execution.
 *
 * Aggregates all test results for a compliance test run with execution timing
 * and provides convenient methods for calculating pass rates and extracting
 * failures. Serves as the primary output from the ComplianceRunner service.
 *
 * @psalm-immutable
 */
final readonly class TestSuite
{
     ...
     *
     * @param string $name Human-readable name of the compliance test suite
